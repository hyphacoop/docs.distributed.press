...
Navigate to your Distributed Press instace and go to `/v1/docs` which will open up the Open-API interface to talk to your instance.
...
Replace the text "string" with some sort of name or domain. e.g. if you're publisher is Hypha, you can use `hypha.coop` for their name.
