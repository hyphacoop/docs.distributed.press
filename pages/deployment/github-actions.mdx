...
[This Github action](https://github.com/marketplace/actions/publish-to-distributed-press) will zip your site together in a single file and use the Distributed Press to create and make updates to the content published on your web server every time it is triggered (this particular project is triggered when you push to the `main` branch of the Github Repo the Github Action is created in.
