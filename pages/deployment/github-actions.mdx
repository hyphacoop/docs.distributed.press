...
```html
<!-- Published with Distributed Press Snippet -->
<div style="text-align: center; margin-top: 20px; padding: 8px;">
  <!-- Powered By Text -->
  <div>Powered by</div>
  <!-- Distributed Press Logo -->
  ...
  <!-- Links Below Logo -->
  <p>
    <a href="//reader.distributed.press" target="_blank" rel="noopener noreferrer">Follow on ActivityPub</a> |
    <a href="//docs.distributed.press" target="_blank" rel="noopener noreferrer">Learn More</a>
  </p>
</div>
```